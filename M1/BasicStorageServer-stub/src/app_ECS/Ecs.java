...
public class Ecs {
    ...
    String privateKey = "/Users/warefhaque/.ssh/id_rsa";
    ...
    public void initService(int numberOfNodes){
        ...
        int port = 22;
        String user = "warefhaque";
        String host = "127.0.0.1";
        ssh(user,port,host);

    }

    public void ssh(String user, int port, String host){
        JSch ssh = new JSch();
        Session session;
        try {
            session = ssh.getSession(user,"127.0.0.1");
    ...
    void readFile(){
        ...
        FileReader fr = null;
        String FILENAME = "src/app_ECS/ecs.conf";
        ...
        try {
            ...
            while ((sCurrentLine = br.readLine()) != null) {
                ...
                //make sure doesn't keep adding and creating duplicates
